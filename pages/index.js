...
{/* Year Range Slider - FROM WORKING SCRIPT */}
<div>
  <label style={{
    display: 'block',
    fontSize: '0.8rem',
  ...
  <div style={{ position: 'relative', marginBottom: '1rem' }}>
    <div style={{
      ...
      {/* Min Handle - FIXED: pointerEvents: 'auto' */}
      <input
        type="range"
        min={MIN_YEAR}
        max={MAX_YEAR}
        ...
        style={{
          ...
          pointerEvents: 'auto',  // ✅ INI YANG BENAR!
          cursor: 'pointer',
          zIndex: 3
        }}
      />
      
      {/* Max Handle - FIXED: pointerEvents: 'auto' */}
      <input
        type="range"
        min={MIN_YEAR}
        max={MAX_YEAR}
